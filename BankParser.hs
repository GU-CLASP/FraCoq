...
overrides (319,1,"p") = Just "s_319_1_p_ALT" -- gf syntax use impersonal instead of "it" pronoun
overrides (319,2,"p") = Just "s_319_2_p_ALT" -- gf syntax use impersonal instead of "it" pronoun
overrides (320,1,"p") = Just "s_320_1_p_ALT" -- gf uses the wrong pronoun heRefl vs he
