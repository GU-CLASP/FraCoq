...
- Task driven; don't aim to cover 100% of everything.
  - John runs a marathon /= john runs
- 
...
For the moment, verbs in the progressive form are treated as independent:

John was writing a book -> ∃t1, t2. t1<= t2, t2 <= now, PROG_write(John,book,t1,t2)
John wrote a book -> ∃t1, t2. t1<= t2, t2 <= now, write(John,book,t1,t2)

What we need is the implication write(x,y,t1,t2) -> PROG_write(x,y,t1,t2) --- but it's not tested by FraCaS
