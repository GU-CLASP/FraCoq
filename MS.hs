...
lexemeN x@"job_N" = genderedN x [Neutral]
...
lexemeAdv "from_1988_to_1992_Adv" = return $ usingTime (ExactTime (Con "Date_19880101",Con "Date_19921231"))
lexemeAdv "in_1990_Adv" = inIntervalAdv (Con "Date_19900101") (Con "Date_19901231")
