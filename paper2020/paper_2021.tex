...
\title{Temporal Semantics to Go: A Complete Run of the FraCaS Test Suite}
...
Our particular implementation does not handle every case 
(citations anonymized) \citet{bernardy_computational_2020,bernardy_wide-coverage_2019} \fi
...
reader to our previous work for details  (citations anonymized)
\citet{bernardy_type-theoretical_2017,bernardy_wide-coverage_2019}, but the particular
...
anaphora (citation anonymized)
\citep{bernardy_computational_2018,bernardy_wide-coverage_2019}.
...
addition to \verb!FORALL! --- see (citation anonymized)
 \citet{bernardy_type-theoretical_2017} )
...
%
We use the same combination of a number of well-studied tools as \cite{bernardy_wide-coverage_2019} : type
...
\iffalse\section*{Acknowledgements}
