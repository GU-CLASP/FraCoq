...
\setlist[subex,1]{parsep=0pt,itemsep=1pt,label=\textbf{P\arabic*}}
\newcommand\hyp{\item[\textbf{H}]}
...
\item[existentially quantifying] The majority of temporal adverbs
  ...
  \[⟦\text{in 1992, \(s\)}⟧(...) = ∃t_1,t_2.  [t_1,t_2] ⊆ 1992, ⟦s⟧(t_1,t_2)\]
...
\item[universally quantifying] A few adverbs introduce intervals via a
  ...
  % ⟦``every month s''⟧(t_0,t_1) = ∀t. [t,t+1month] ⊆ [t_0,t_1], ⟦s⟧(t,t+1month)
\end{enumerate}
