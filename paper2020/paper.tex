...
subinterval of $t_1$ and the progressiver sentence is true at $t_1$ \citep{ogihara2007tense}. In terms of implementation, the solution we provide here seems to be simpler.}
