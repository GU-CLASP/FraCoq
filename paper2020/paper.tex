...
$P$ is \emph{actitivty}~\citep{steedman_productions_2000} (which, for our
...
temporal subsumption properties.
...
non-instanteous. To the contrary, for accomplishment verbs, the
inference follows.
