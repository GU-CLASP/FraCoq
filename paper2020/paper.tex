...
\author{\authorname{Jean-Philippe Bernardy} \authorname{Stergios Chatzikyriakidis}
  \affiliation{CLASP, Deparment of Philosophy, Linguistics and Theory of Science, University of Gothenburg}
  \email{firstname.lastname@gu.se}}

\keywords{Temporal Semantics, Type-Theory, Natural Language Inference, Formal Semantics, FraCaS Test Suite, Coq}

\abstract{In this paper, we propose an implementation of temporal semantics
  ...
  and progressives.  We apply these semantics to the complete FraCaS testsuite.
  We obtain an accuracy of 81 percent overall and 73 percent for problems explicitly marked
  as related to temporal reference.
}
