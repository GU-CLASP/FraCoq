...
operators for several constructions (FORALL, Not, IS_INTERVAL,
appTime). This use of custom operators is useful for several
generalisations (for example, we have quantifiers such as MOST in
addition to FORALL.)
