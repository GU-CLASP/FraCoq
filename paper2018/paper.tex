...
Contained Deletion ellipsis example \ref{ex:acd} below.\todo{It'd be nice to have a more clear parallel with indefinite articles as well; but I could not find this in fracas.}
...
thereby avoiding any syntactic ambiguity. \todo{Do you want to further comment here?}
